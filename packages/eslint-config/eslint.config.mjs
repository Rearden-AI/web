...
export const reardenEslintConfig = {
  extends: [
  ...
  settings: {
    ...
    tailwindcss: {
      ...
      config: require.resolve('@rearden/tailwind-config'),
    },
  },
  rules: {
    ...
    'tailwindcss/no-custom-classname': [
      'error',
      {
        ...
        whitelist: [
          // used by toast
          'destructive',
          // text inherit all style from parent
          'txt-inherit',
          // 2 layers inside linear gradint
