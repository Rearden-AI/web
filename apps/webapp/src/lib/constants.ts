...
const suiImage =
  'https://assets.coingecko.com/asset_platforms/images/126/small/sui.jpeg?1706606546';

const fudImage = 'https://assets.coingecko.com/coins/images/33610/standard/pug-head.png?1702513072';

const fudInfo =
  'https://medium.com/@fortunedivine04/introducing-fud-the-community-meme-coin-for-sui-network-d0b6a349b9cd';

const cetusImage = 'https://www.cetus.zone/favicon.ico';
export const message = `Swap ![](${suiImage})SUI→![](${fudImage})[FUD](${fudInfo}) on ![](${cetusImage}) Cetus.`;

export const suiActions = [
  {
    action_type: ActionType.SWAP,
    details: {
      name: 'Swap SUI→FUD on Cetus.',
      dapp_link: 'https://app.cetus.zone',
      from: 'SUI', // need to add API
      to: 'FUD', // need to add API
      token_address_in: null,
      network: 99999999999,
    },
    body: {
      token_address_in: null,
      contract_address: '0x6f5e582ede61fe5395b50c4a449ec11479a54d7ff8e0158247adfda60d98970b',
      pool_address: '0xfc6a11998f1acf1dd55acb58acd7716564049cfd5fd95e754b0b4fe9444f4c9d',
    },
  },
  {
    action_type: ActionType.SWAP,
    details: {
      name: 'Swap SUI→SCB on Cetus.',
      dapp_link: 'https://app.cetus.zone',
      from: 'SUI', // need to add API
      to: 'SCB', // need to add API
      token_address_in: null,
      network: 99999999999,
    },
    body: {
      token_address_in: null,
      contract_address: '0x6f5e582ede61fe5395b50c4a449ec11479a54d7ff8e0158247adfda60d98970b',
      pool_address: '0xbc49bd0a3b476825e7157567a615cd3d2154c76d72df8e81da0c0a0eabaa3e97',
    },
  },
];

export const mockSui = {
  name: null,
  uuid: `1`,
  created_at: new Date(),
